...
LGUI_T(KC_Q),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              RSFT_T(KC_J),      RCTL_T(KC_K),      ALGR_T(KC_L),      RGUI_T(KC_M),      \
...
LGUI_T(KC_Y),      LALT_T(KC_I),      LCTL_T(KC_E),      LSFT_T(KC_A),      KC_DOT,            KC_D,              RSFT_T(KC_S),      RCTL_T(KC_T),      ALGR_T(KC_N),      RGUI_T(KC_B),      \
...
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_D,              KC_H,              RSFT_T(KC_N),      RCTL_T(KC_E),      ALGR_T(KC_I),      RGUI_T(KC_O),      \
...
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_M,              RSFT_T(KC_N),      RCTL_T(KC_E),      ALGR_T(KC_I),      RGUI_T(KC_O),      \
...
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_K,              RSFT_T(KC_N),      RCTL_T(KC_E),      ALGR_T(KC_I),      RGUI_T(KC_O),      \
...
LGUI_T(KC_A),      LALT_T(KC_O),      LCTL_T(KC_E),      LSFT_T(KC_U),      KC_I,              KC_D,              RSFT_T(KC_H),      RCTL_T(KC_T),      ALGR_T(KC_N),      RGUI_T(KC_S),      \
...
LGUI_T(KC_S),      LALT_T(KC_H),      LCTL_T(KC_N),      LSFT_T(KC_T),      KC_COMM,           KC_DOT,            RSFT_T(KC_A),      RCTL_T(KC_E),      ALGR_T(KC_O),      RGUI_T(KC_I),      \
...
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_H),      LSFT_T(KC_T),      KC_G,              KC_Y,              RSFT_T(KC_N),      RCTL_T(KC_E),      ALGR_T(KC_O),      RGUI_T(KC_I),      \
...
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              RSFT_T(KC_J),      RCTL_T(KC_K),      ALGR_T(KC_L),      RGUI_T(KC_QUOT),   \
...
KC_PGDN,           KC_LEFT,           KC_DOWN,           KC_RGHT,           CW_TOGG,           U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
...
KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           CW_TOGG,           U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              TD(U_TD_U_NAV),    TD(U_TD_U_NUM),    KC_ALGR,           U_NA,              \
U_NP,              U_NP,              KC_DEL,            KC_BSPC,           KC_ENT,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
MS_WHLD,           MS_LEFT,           MS_DOWN,           MS_RGHT,           U_NU,              U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
...
MS_LEFT,           MS_DOWN,           MS_UP,             MS_RGHT,           U_NU,              U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              TD(U_TD_U_MOUSE),  TD(U_TD_U_SYM),    KC_ALGR,           U_NA,              \
U_NP,              U_NP,              MS_BTN3,           MS_BTN1,           MS_BTN2,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
UG_NEXT,           KC_MPRV,           KC_VOLD,           KC_MNXT,           U_NU,              U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
...
KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           U_NU,              U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
U_NU,              U_NU,              U_NU,              U_NU,              OU_AUTO,           U_NA,              TD(U_TD_U_MEDIA),  TD(U_TD_U_FUN),    KC_ALGR,           U_NA,              \
U_NP,              U_NP,              KC_MUTE,           KC_MPLY,           KC_MSTP,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
KC_SCLN,           KC_4,              KC_5,              KC_6,              KC_EQL,            U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
...
KC_COLN,           KC_DLR,            KC_PERC,           KC_CIRC,           KC_PLUS,           U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
...
KC_F11,            KC_F4,             KC_F5,             KC_F6,             KC_SCRL,           U_NA,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NU,              U_NU,              KC_RSFT,           KC_RCTL,           KC_ALGR,           KC_RGUI,           \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
